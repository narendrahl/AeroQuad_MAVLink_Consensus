...
void initHomeBase() {
  ...
  */
  ...
  #define MIN_DISTANCE_TO_REACHED 40

//  #define MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION 300.0

//#define MAX_NAVIGATION_ANGLE_CORRECTION 50
#ifdef Follower3
#define MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION 80  // Changed by indrajit
  #define POSITION_HOLD_SPEED 40.0  
//  #define MAX_NAVIGATION_ANGLE_CORRECTION 300.0
  #define MAX_NAVIGATION_ANGLE_CORRECTION 80      
  #define NAVIGATION_SPEED 8.0//30.0 
#endif


#if defined Follower2
#define MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION 45  // Changed by indrajit
  #define POSITION_HOLD_SPEED 40.0  
//  #define MAX_NAVIGATION_ANGLE_CORRECTION 300.0
  #define MAX_NAVIGATION_ANGLE_CORRECTION 45      
  #define NAVIGATION_SPEED 6.0//30.0 
//  nav_an_co = 45;
//  nav_speed = 6;
#endif
...
//#define MAX_NAVIGATION_ANGLE_CORRECTION 50
#ifdef Follower1
#define MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION 40  // Changed by indrajit
  #define POSITION_HOLD_SPEED 40.0  
//  #define MAX_NAVIGATION_ANGLE_CORRECTION 300.0
  #define MAX_NAVIGATION_ANGLE_CORRECTION 40      
  #define NAVIGATION_SPEED 7.0//30.0 
#endif
...
//        #endif                                         //commented on 3-mar-2015
      ...
      missionPositionToReach.altitude = baroAltitudeToHoldTarget;//waypoint[waypointIndex].altitude;
        #endif
       #else 
      missionPositionToReach.latitude = positionHoldPointToReach.latitude;          //added on 3-mar-2015
      missionPositionToReach.longitude = positionHoldPointToReach.longitude;              //added on 3-mar-2015
      missionPositionToReach.altitude = baroAltitudeToHoldTarget;                //added on 3-mar-2015
        #endif
      }
    if (missionPositionToReach.altitude > 5) {
        missionPositionToReach.altitude = 2.5; // fix max altitude to 2 km
      }         
 ...
 //   curr_X = currentSpeedX;
 //   curr_Y = currentSpeedY;
    ...
    curr_X = currentSpeedRoll;
    curr_Y = currentSpeedPitch;
  }
  ...
  void computeRollPitchCraftAxisCorrection() {
   ...
   //  tmpcos = cos(atan2(distanceToDestinationX, distanceToDestinationY));
    ...
    RSD = rollSpeedDesired;
    PSD = pitchSpeedDesired;

   // rollVel = At * (1/NN) * (( RSD ) + (Cx - curr_X));
    
   // pitchVel = At * (1/NN) * (( PSD ) + (Cy - curr_Y));
    ...
    int tempGpsRollAxisCorrection = updatePID(RSD, currentSpeedRoll, &PID[GPSROLL_PID_IDX]);
    int tempGpsPitchAxisCorrection = updatePID(PSD, currentSpeedPitch, &PID[GPSPITCH_PID_IDX]);
...
//      Serial2.print('X');
  ...
  //    Serial2.print('Y');      
      computeEstimatedPosition();    //disabled on 3 mar 15
    }    
  ...
  //baroAltitudeToHoldTarget = positionHoldPointToReach.altitude;  // commented by indrajit
    ...
    //Serial.print(baroAltitudeToHoldTarget);
/*
 if(C==3){
    Serial2.print(baroAltitudeToHoldTarget);
    Serial2.print(':');
...
//    Serial2.print(waypointIndex);
  //  Serial2.print(':');
   ...
   // Serial2.print(':');
    ...
    Serial2.print(':');
    Serial2.print(curr_X);
    Serial2.print(':');
    Serial2.print(curr_Y);
    Serial2.print(':');
    C=0;
 }
 else
...
//      Serial2.print('N');
 ...
 maxCraftAngleCorrection =  nav_an_co ;
 maxSpeedToDestination = nav_speed ;
...
//    evaluateAltitudeCorrection();    //commented on 3 mar 15, coz everything has been commented in the function
