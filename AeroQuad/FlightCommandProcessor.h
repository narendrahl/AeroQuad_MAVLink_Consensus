...
int FLG = 1;
  ...
  boolean isPositionHoldEnabledByUser() {
    ...
    if(receiverCommand[AUX1] > 1240 && receiverCommand[AUX1] < 1250)
        {
          return true; }
     if((receiverCommand[AUX2] > 1240 && receiverCommand[AUX2] < 1750) || (receiverCommand[AUX2] > 900 && receiverCommand[AUX2] < 1100)) //Second condition is for default values
      {
       return true;}
...
//     Serial.print('X'); 
   //  Serial.print(positionHoldState);
...
//        Serial.print('X');
        ...
        altitudeHoldThrottle = receiverCommand[THROTTLE]+10; // +10 Added on 21 Feb 15
...
//      baroAltitudeToHoldTarget = curr_alt;
      ...
      // Serial.print('L');
        ...
        positionHoldPointToReach.longitude = currentPosition.longitude;
//        positionHoldPointToReach.altitude = getBaroAltitude();           // Disabled on 21 Feb 2015
        positionHoldPointToReach.altitude = baroAltitudeToHoldTarget;     //Added on 21 Feb 2015
