...
void initializeEEPROM() {
  PID[RATE_XAXIS_PID_IDX].P = 200.0;
  PID[RATE_XAXIS_PID_IDX].I = 0.1;
  PID[RATE_XAXIS_PID_IDX].D = 0;
  PID[RATE_YAXIS_PID_IDX].P = 200.0;
  PID[RATE_YAXIS_PID_IDX].I = 0.1;
  PID[RATE_YAXIS_PID_IDX].D = 0;
  ...
  rotationSpeedFactor = 1;
    ...
    PID[BARO_ALTITUDE_HOLD_PID_IDX].P = 60.0;
    PID[BARO_ALTITUDE_HOLD_PID_IDX].I = 8;
    PID[BARO_ALTITUDE_HOLD_PID_IDX].D = 0;
    ...
    minThrottleAdjust = -35.0;
    maxThrottleAdjust = 40.0; //we don't want it to be able to take over totally
    #if defined AltitudeHoldBaro
  ...
  // Range Finder
    ...
    missionNbPoint = 0;
    PID[GPSROLL_PID_IDX].P = 3.5;
    PID[GPSROLL_PID_IDX].I = 0.3;
    PID[GPSROLL_PID_IDX].D = 0.0;
    PID[GPSPITCH_PID_IDX].P = 3.5;
    PID[GPSPITCH_PID_IDX].I = 0.3;
