...
26 Apr 2015
HeadingHoldProcessor.h in all : -
(receiverCommand[ZAXIS] + gpsYawAxisCorrection) > (MIDCOMMAND + 50 )


Orange - 123 - Speed = 8 , MAX_NAVIGATION_ANGLE_CORRECTION 70.0 , MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION = 70  ,  Attitude Mode - I = 0.1 , Heading Hold Propotional = 3 ( Aeroquad Configurator ) , Rest as per Natru.aq
Blue - 122   - Speed = 6 , MAX_NAVIGATION_ANGLE_CORRECTION 40.0 , MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION = 40 ,  Attitude Mode - I = 0.1 , Heading Hold Propotional = 3 , Roll Propotional and Pitch - 2.5 , ( Aeroquad Configurator ) , Rest as per Natru.aq
White - 121  - Speed = 8 , MAX_NAVIGATION_ANGLE_CORRECTION 90.0 , MAX_POSITION_HOLD_CRAFT_ANGLE_CORRECTION = 90 ,  Attitude Mode - I = 0 , Heading Hold Propotional = 3 ( Aeroquad Configurator ) , Rest as per Natru.aq

Watch out for AngleToWaypoint ..
...
// Enable either one of the following (rangefinder preffered) 
...
// Sudeep Define UseGPSNavigator
#define UseGPSNavigator

#define LeaderFollower
//#define Leader     // Defines this quadcopter as the leader.
#define Follower
//#define Follower_1
...
#define MAV_SYSTEM_ID 121  //0		// Needs to be enabled when using MavLink, used to identify each of your copters using MavLink
//#define Follower2
//#define Follower3
#define Follower1								// If you've only got one, leave the default value unchanged, otherwise make sure that each copter has a different ID 

#define CONFIG_BAUDRATE 9600  // overrides default baudrate for serial port (Configurator/MavLink/WirelessTelemetry)
//7890
...
/// AeroQuad Configurator sends !!!!!X to initiate connection.
/****************************************************************************
 ****************************************************************************
 ****************************************************************************
