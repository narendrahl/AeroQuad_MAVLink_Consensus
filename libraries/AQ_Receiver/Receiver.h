...
#define MINCHECKthrottle 1350
//#define MINCHECKthrottle 1000			// Sudeep value for hobbyking tx-rx
...
void initializeReceiverParam(int nbChannel = 8) {
